...
use crate::core::compression::{read_seek_index, ZstdSeekIndex};
...
impl StorageReader {
    ...
    pub fn next(&mut self) -> Result<Option<crate::core::MessageView<'_>>> {
        loop {
            ...
            return Ok(Some(crate::core::MessageView {
                seq: header.seq,
